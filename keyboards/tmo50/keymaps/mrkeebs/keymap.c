...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_space(
		...
		KC_END,  KC_LGUI, KC_LALT,                 KC_EXSP,             KC_LCTL
  ),
  ...
  [_EXTR] = LAYOUT_space(
		...
		_______, KC_ESC,  _______, _______, _______
  ),

  // Control layer
  [_CTRL] = LAYOUT_space(
		TG(_ALT), _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  KC_UP,   _______, KC_DEL,
		KC_BRID, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, RESET,
