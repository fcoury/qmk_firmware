...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_default(
		...
		KC_PGDN, KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, MO(_CTRL),
		KC_END,  KC_LALT, KC_LGUI,                 KC_EXSP, KC_SPC,            KC_RALT, KC_LCTL
  ),
  ...
  [_ALT] = LAYOUT_default(
		...
		MC_VOLD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  ...
  [_CTRL] = LAYOUT_default(
		...
		_______,    _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, _______, KC_END,  KC_PGDN, KC_DOWN, _______, _______,
		_______,    _______, _______, _______, _______, _______, _______
  ),

  // Extra keys layer
  [_EXTR] = LAYOUT_default(
		...
		_______, _______, _______, _______, _______, _______, KC_SPC,  _______, _______, _______, _______, _______, KC_BSLS, _______, _______,
  ...
  [_RGB] = LAYOUT_default(
    RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______,
		...
		_______, _______, _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, BL_STEP, BL_DEC, _______, _______, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, _______
  ),
};
