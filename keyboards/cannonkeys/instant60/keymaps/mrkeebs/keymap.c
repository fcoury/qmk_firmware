...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_CTRL] = LAYOUT_60_tsangan_hhkb(
      ...
      _______, KC_PSCR, KC_SLCK, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_DOWN, KC_TWIN, _______,
		  _______, _______, _______, _______, KC_TWIN, KC_TWIN, KC_TWIN
      ),
};
