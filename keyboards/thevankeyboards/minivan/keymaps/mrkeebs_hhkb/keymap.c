...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_arrow( /* Qwerty */
    ...
    KC_LCTL,              KC_LGUI, KC_LALT, LT(1, KC_SPC), KC_SPC, MO(4), KC_LEFT, KC_DOWN, KC_RIGHT
  ),
  ...
  [2] = LAYOUT_arrow( /* LAYER 2 */
    ...
    _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, KC_MPLY, _______, _______, KC_UNDS, KC_LEFT, KC_RGHT, _______,
    _______, KC_PSCR, KC_LSCR, _______, _______, _______, _______, _______, KC_LCBR, KC_DOWN, KC_PGUP, KC_PIPE,
    _______, _______, _______,                   _______, _______,          _______, KC_HOME, KC_PGDN, KC_END
  ),
