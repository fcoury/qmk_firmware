...
LAYOUT( /* Left */
  ...
  _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, KC_UNDERSCORE, KC_PLUS, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_PIPE,
  _______, KC_PSCR, KC_LSCR, _______, KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
