...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_stt(
        ...
        KC_LALT, KC_LGUI,                                  KC_SPC,                          KC_RGUI, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT, KC_P0    \
    ),
    ...
    [1] = LAYOUT_stt(
        ...
        _______, KC_MUTE,  KC_VOLD,  KC_VOLU,  RGB_TOG,  RGB_MOD,  RGB_HUI,  RGB_SAI,  RGB_VAI,  RGB_SPI,            _______, _______, _______, KC_LEFT, _______, KC_RGHT,          \
        _______, _______,  _______,  _______,  RGB_RMOD, RGB_HUD,  RGB_SAD,  RGB_VAD,  RGB_SPD,            _______,  _______, _______, _______, KC_END , KC_DOWN, KC_PGDN,          \
