...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_stt(
        ...
        _______, KC_MUTE,  KC_VOLU,  KC_VOLD,  RGB_TOG,  RGB_MOD,  RGB_HUI,  RGB_SAI,  RGB_VAI,  RGB_SPI,  _______,  _______, _______, _______, _______, _______, _______, \
        _______, _______,  _______,  _______,  _______,  RGB_RMOD, RGB_HUD,  RGB_SAD,  RGB_VAD,  RGB_SPD,  _______,  _______, _______, _______, _______, _______,          \
