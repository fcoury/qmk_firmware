 ...
 */
  ...
  KEYMAP_DIRECTIONAL(
      ...
      KC_LSFT,               ______,  KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  MT(MOD_RSFT, KC_SLSH), KC_UP,   LT(1, KC_SLSH),
 ...
 */
  ...
  KEYMAP_DIRECTIONAL(
      ...
      ______, ______, KC_PSCR, KC_LSCR, ______, ______, ______, ______, ______, ______, ______, KC_HOME, KC_PGUP, KC_END,
      ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_PGDN, ______
      ),
};
