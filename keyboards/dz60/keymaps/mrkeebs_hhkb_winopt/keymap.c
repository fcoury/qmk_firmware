 ...
 */
  ...
  [_BASE] = LAYOUT(
      ...
      KC_LSFT,               _______,   KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SLSH, MO(_CTRL),
  ...
  [_CTRL] = LAYOUT(
      ...
      _______, _______, KC_PSCR, KC_SLCK, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_DOWN, _______, _______,
		  _______, _______, _______, _______, _______, _______, _______, _______, KC_TWIN, _______, _______
      ),
};
