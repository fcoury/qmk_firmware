/* Copyright 2015-2017 MrKeebs <felipe.coury@gmail.com>
 *
 ...
 */
  ...
  [_BASE] = LAYOUT_60_ansi_split_bs_rshift(
      ...
      KC_LSFT,               KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SLSH, MO(_CTRL),
  ...
  [_WIN] = LAYOUT_60_ansi_split_bs_rshift(
      ...
      _______, _______,  _______,    _______,   _______,   _______,   _______,    _______,    _______,    _______, _______,  _______, _______, _______,
      KC_LCTL,        KC_LGUI,      KC_LALT,      KC_SPC,       _______,         KC_RALT,          KC_RGUI, KC_RCTL \
      ),

  [_CTRL] = LAYOUT_60_ansi_split_bs_rshift(
      ...
      _______, KC_PSCR, KC_SLCK, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_DOWN, _______, _______,
      _______,        _______,      _______,      _______,       _______,         KC_TWIN,          _______, _______ \
      ),
