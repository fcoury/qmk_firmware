...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
	...
	[0] = LAYOUT( /* Base */
		...
		KC_LCTL, KC_LALT, KC_LGUI,          KC_SPC,           KC_SPC,           KC_SPC,                    MO(1),   KC_GRV,  KC_LEFT, KC_DOWN, KC_RGHT
	),
	[1] = LAYOUT( /* FN */
		RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_DEL,  KC_GRV,
		_______,          _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______, KC_HOME,
		_______,          KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, _______,   _______, _______,          _______, KC_END,
