...
[0] = LAYOUT(
  ...
  KC_LALT,KC_LCTL,KC_LGUI,                 KC_SPC,                                _______, KC_RGUI, KC_RALT,MO(1),  KC_LEFT,KC_DOWN,KC_RGHT), \
...
[1] = LAYOUT(\
  ...
  _______,   KC_MUTE,   KC_VOLD,   _______,   KC_VOLU,   _______,   _______,   _______,   _______,   _______,_______,_______,         _______,                          \
