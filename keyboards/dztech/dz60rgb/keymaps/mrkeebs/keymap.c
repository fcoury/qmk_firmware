...
#define KC_SLSF MT(MOD_RSFT, KC_SLSH)  // Control held, Tab pressed
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[_LAYER0] = LAYOUT( /* Base */
		    ...
		    KC_LSFT,  KC_Z,     KC_X,     KC_C,  KC_V,  KC_B,  KC_N,    KC_M,  KC_COMM, KC_DOT,   KC_SLSF, KC_UP,             LT(2, KC_DEL),\
